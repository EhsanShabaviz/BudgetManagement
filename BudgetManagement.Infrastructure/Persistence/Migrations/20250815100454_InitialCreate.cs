        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgentContractNumber = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    AgentContractDate = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ExecutionType = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    CurrentYearCashCredit = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
                    CurrentYearNonCashCredit = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
                    ...
                    ResponsibleDept = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    ActivityType = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    ...
                    Increase25Percent = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
                    ...
                    CreditDeficit = table.Column<decimal>(type: "decimal(18,0)", nullable: true)
                },
                constraints: table =>
                {
